    ...
    return (
      <div>
        <div className={styles.heading}>
          <h1>
            Build your creative project <br /> to life.
          </h1>

          <NavLink to="/start/startAProjectPage1">
        ...
        <div className={styles.blue}>
          <div>
            ...
            support an idea and make it a reality. <br />
            <br></br>
            <p style={{ fontSize: "15px" }}> - DE LA SOUL</p>
          </div>
        </div>
        <div className={styles.middle}>
          <Container>
            ...
            <Row className="mb-5">
              ...
              <Col md={6}>
                <p>
                  ...
                  score a film — you name it. Read more about our project
                  guidelines.
                </p>
              </Col>
            </Row>
            ...
            <Row className="mb-5">
              <Col>
                <h2>How much work is it to run a project?</h2>
              </Col>
              <Col>
                <p>
            ...
            <Row className="mb-5">
              ...
              <Col>
                <p>
                  You can reach out with your questions through this contact
                  form. We also recommend taking a look at our FAQs for more
                  detailed information, along with the creator handbook for
                  guidance on starting and running a project.
                </p>
              </Col>
            </Row>
          </Container>
          ...
          <div className={styles.middle}>
            <Container>
              ...
              <Row className="mb-5">
                ...
                <Col md={6}>
                  <p>
                    We built Kickstarter as a tool for artists, designers,
                    makers, musicians, and creative people everywhere. We’re
                    proud to be the only platform that’s fully dedicated to
                    building community around creative projects.
                  </p>
                </Col>
              </Row>
              <Row className="mb-5">
              ...
              <Row className="mb-5">
                <Col>
                  <h2>Our community wants to support you.</h2>
                </Col>
                <Col>
                  <p>
                    Millions of backers agree — helping to create something new
                    ...
                    Kickstarter projects to life over the years.
                  </p>
                </Col>
              </Row>
            </Container>
        ...
        >
          <Container>
            <Row className="mb-3">
              <Col>
                <h1>
                  Create a project in any of the <br />
            ...
            <Row className="mb-2">
              <Col md={6}>
                <h4>
                  From backyard performances to large public murals, thousands
                  of arts projects have broken new ground, sparked meaningful
                  dialogue, and given people the opportunity to share their work
                  with the world.
                </h4>
              </Col>
              <Col md={6}>
                <div style={{ border: "1px solid black", padding: 15 }}>
                  <h2>Interested?</h2>
                  <p>
                    Click start and get sketching. See how it looks. Then share
                  ...
                  <p>
                    We're here for you! Our Community Managers know all about
                    running projects in each of our categories. Drop us a line
                    about your project idea: art@kickstarter.com. Got questions
                    about something else? Visit our Help center.
                  </p>
                </div>
              </Col>
            </Row>
            ...
            <Row>
              <Col md={3}>
                <div>
                  <img
                    src="https://ksr-ugc.imgix.net/assets/011/536/188/8f61f3b115b209d585bfa98902aa9cf4_original.jpeg?ixlib=rb-2.1.0&crop=faces&w=608&h=342&fit=crop&v=1463684144&auto=format&frame=1&q=92&s=539d24c7181801a75071e94aa4225795"
                    alt="img"
                    width="250px"
                  />
                  <p>
                    <a style={{ font: "12px Arial" }} href="google.com">
        ...
        >
          <div className={styles.middle}>
            <h1>“A way for every creative person to control their destiny.”</h1>
            <p>— Brian Fargo, successful Kickstarter project creator</p>
            <button onClick={this.handleStartProject} className={styles.btn}>
              Start a project
            </button>
          </div>
        </div>
